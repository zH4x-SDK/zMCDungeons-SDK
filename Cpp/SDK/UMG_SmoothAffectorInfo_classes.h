...
// WidgetBlueprintGeneratedClass UMG_SmoothAffectorInfo.UMG_SmoothAffectorInfo_C
// 0x0000
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UMG_SmoothAffectorInfo.UMG_SmoothAffectorInfo_C");
		return ptr;
	}
	...
	void SetCollapsed();
	void Tick();
	void ExecuteUbergraph_UMG_SmoothAffectorInfo();
};
