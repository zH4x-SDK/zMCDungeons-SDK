...
// Enum InputCore.EInputPhysicality
enum class InputCore_EInputPhysicality : uint8_t
{
	EInputPhysicality__None        = 0,
	EInputPhysicality__Physical    = 1,
	EInputPhysicality__Virtual     = 2,
	EInputPhysicality__Both        = 3,
	EInputPhysicality__EInputPhysicality_MAX = 4,
